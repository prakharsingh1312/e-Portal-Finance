...
$pdf->cell(10,7,'',0,0);
$pdf->MultiCell(170,14,'6. Place (S) of the event (Visit) Conference /  Training Course /  Workshop Seminar / Symposium / Others (Complete Address):   lace (S) of the event (Visit) Conference /  Training Course /  lace (S) of the event (Visit) Conference /  Training Course /  lace (S) of the event (Visit) Conference /  Training Course /  ',1,1);
